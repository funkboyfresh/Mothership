        ...
        deities: [
            ...
            },
            {
                ...
                sectors: [
                    ...
                    { id: 4, name: "The Pendulum", keystone: "Momentum Swing", coords: [{x:20,y:40}, {x:50,y:20}, {x:80,y:40}, {x:50,y:60}, {x:50,y:90}], perk: "MOMENTUM: Consecutive tasks grant +1% Energy" },
                    { id: 5, name: "Infinity Knot", keystone: "Eternal Loop", coords: [{x:40,y:30}, {x:60,y:30}, {x:60,y:70}, {x:40,y:70}, {x:50,y:50}], perk: "ETERNAL LOOP: Targets have 5% chance to auto-respawn" }
                ],
            ...
            },
            {
                ...
                sectors: [
                    ...
                    { id: 4, name: "Phalanx Array", keystone: "Vanguard Formation", coords: [{x:30,y:20}, {x:70,y:20}, {x:80,y:50}, {x:70,y:80}, {x:30,y:80}], perk: "GUARD: Shield Sub-Routines +10% strength" },
                    { id: 5, name: "Bastion Peak", keystone: "Immortal Warden", coords: [{x:50,y:10}, {x:20,y:40}, {x:80,y:40}, {x:50,y:60}, {x:50,y:90}], perk: "IMMORTAL WARDEN: Energy never drops below 1" }
                ],
        ...
        deities: [
            {
                ...
                sectors: [
                    { id: 1, name: "Shadow Blade", keystone: "First Strike", coords: [{x:20,y:80}, {x:40,y:60}, {x:60,y:40}, {x:80,y:20}, {x:50,y:50}], perk: "UNDERWORLD: +2% Market Rate" },
                    { id: 2, name: "Veil of Mist", keystone: "Smoke Screen", coords: [{x:20,y:20}, {x:30,y:30}, {x:50,y:40}, {x:70,y:30}, {x:80,y:20}], perk: "CLOAK: Hidden bounty payouts +5%" },
                    ...
                    { id: 4, name: "The Eclipse", keystone: "Total Darkness", coords: [{x:50,y:10}, {x:30,y:30}, {x:20,y:50}, {x:30,y:70}, {x:50,y:90}], perk: "VOID-SIGHT: Rare encounters +2%" },
                    { id: 5, name: "Void Cloak", keystone: "Phantom Drive", coords: [{x:20,y:20}, {x:80,y:20}, {x:80,y:80}, {x:20,y:80}, {x:50,y:20}], perk: "PHANTOM DRIVE: +10% Offline generation" }
                ],
            ...
            },
            {
                ...
                sectors: [
                    ...
                    { id: 4, name: "Tesseract Frame", keystone: "Folded Space", coords: [{x:25,y:25}, {x:75,y:25}, {x:75,y:75}, {x:25,y:75}, {x:40,y:40}], perk: "FOLDED SPACE: Cargo capacity +10%" },
                    { id: 5, name: "The Singularity", keystone: "Event Horizon", coords: [{x:50,y:10}, {x:10,y:50}, {x:50,y:90}, {x:90,y:50}, {x:50,y:50}], perk: "TRUE SHAPER: 5% chance buffs never expire" }
                ],
            ...
            },
            {
                ...
                sectors: [
                    { id: 1, name: "Hunter's Mark", keystone: "The Quarry", coords: [{x:50,y:10}, {x:50,y:90}, {x:10,y:50}, {x:90,y:50}, {x:50,y:50}], perk: "BLOOD-MONEY: Bounties +2%" },
                    { id: 2, name: "Jagged Talon", keystone: "Deep Wound", coords: [{x:20,y:20}, {x:40,y:40}, {x:20,y:50}, {x:40,y:60}, {x:20,y:80}], perk: "TRACKER: Rare spawns +1%" },
                    ...
                    { id: 4, name: "Stellar Sight", keystone: "True Vision", coords: [{x:20,y:50}, {x:40,y:30}, {x:60,y:30}, {x:80,y:50}, {x:50,y:50}], perk: "PREDATOR: Critical bounty chance +3%" },
                    { id: 5, name: "Apex Strike", keystone: "Killing Blow", coords: [{x:50,y:20}, {x:30,y:40}, {x:70,y:40}, {x:50,y:80}, {x:50,y:50}], perk: "OBLITERATION: Bonus Scrap on all kills" }
                ],
        ...
        deities: [
            {
                ...
                sectors: [
                    { id: 1, name: "Impact Crater", keystone: "Meteor Strike", coords: [{x:40,y:40}, {x:60,y:40}, {x:60,y:60}, {x:40,y:60}, {x:50,y:10}], perk: "KINETIC: +2% Boss Damage" },
                    { id: 2, name: "Shattered Spine", keystone: "Brutal Force", coords: [{x:10,y:90}, {x:30,y:70}, {x:50,y:80}, {x:70,y:60}, {x:90,y:70}], perk: "RAGE: Energy loss adds +1% Damage" },
            ...
            },
            {
                ...
                sectors: [
                    ...
                    { id: 4, name: "Stellar Ribbon", keystone: "Cosmic Flow", coords: [{x:10,y:10}, {x:30,y:20}, {x:70,y:80}, {x:90,y:90}, {x:50,y:50}], perk: "WAVE-FORM: Fast travel cost -5% Scrap" },
                    { id: 5, name: "Cosmic Crown", keystone: "Queen of Stars", coords: [{x:20,y:40}, {x:40,y:20}, {x:60,y:20}, {x:80,y:40}, {x:50,y:60}], perk: "VEIL-BORN: 10% chance to dodge encounters" }
                ],
            ...
            },
            {
                ...
                sectors: [
                    { id: 1, name: "Siphon Root", keystone: "Deep Drain", coords: [{x:50,y:90}, {x:50,y:60}, {x:20,y:40}, {x:80,y:40}, {x:50,y:50}], perk: "DETECTION: Rare spawns +2%" },
                    { id: 2, name: "Hungry Maw", keystone: "Endless Appetite", coords: [{x:50,y:50}, {x:30,y:20}, {x:70,y:20}, {x:30,y:80}, {x:70,y:80}], perk: "SIPHON: Secure rewards +5%" },
                    ...
                    { id: 4, name: "Funnel Core", keystone: "Singularity Point", coords: [{x:10,y:10}, {x:90,y:10}, {x:50,y:90}, {x:30,y:40}, {x:70,y:40}], perk: "GRAVITY: Magnetism pull range +20%" },
                    { id: 5, name: "Solar Scythe", keystone: "The Harvest", coords: [{x:10,y:50}, {x:50,y:10}, {x:90,y:50}, {x:50,y:60}, {x:50,y:90}], perk: "SUN-EATER: Fully clear Sector for permanent +25% boost" }
                ],
